...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        Optional<String> tokenOptional = Optional.ofNullable(
                        request.getHeader(ConstantInfrastructure.CONSTANT_HEADER_AUTHENTICATION))
                .filter(header -> header.startsWith(ConstantInfrastructure.BEARER_PREFIX))
                .map(header -> header.substring(ConstantInfrastructure.BEARER_SUBSTRING));
